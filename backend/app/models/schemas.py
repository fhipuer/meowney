...
class AssetResponse(AssetBase):
    ...
    native_profit_rate: Optional[float] = Field(None, description="환율 반영 전 현지통화 수익률 (%)")
    fx_change_rate: Optional[float] = Field(None, description="매입 시점 대비 환율 변동률 (%)")
    asset_price_effect_krw: Optional[Decimal] = Field(None, description="자산 가격 변동의 원화 손익 효과")
    fx_effect_krw: Optional[Decimal] = Field(None, description="환율 변동의 원화 손익 효과")
    ...
    price_status: Optional[str] = Field(None, description="live, close, cached, stale, manual, unavailable")
